      ...
      <div class="form-group">
        <?php echo Form::open(['route' => 'user.login', 'method' => 'post']); ?>
          ...
          <div id="login" >
            <label>
              <span>Login</span>
              <?php echo Form::text('username', null, ['class' => 'input form-control', 'placeholder'=> 'Digite seu nome de usuario' ]); ?>
          ...
          <div id="password">
            <label>
              <span>Senha</span>
              <?php echo Form::password('username', [ 'class' => 'input form-control', 'placeholder'=> 'Digite sua senha' ]); ?>
        ...
        <div class="botoes">
          <?php echo Form::submit('Entrar' , [ 'class' => 'btn btn-default btn-lg']); ?>

          <?php echo Form::submit('Cadastrar' , [ 'class' => 'btn btn-default btn-lg']); ?>
